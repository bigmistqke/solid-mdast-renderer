...
export default {
  ...
  "renders a simple paragraph": {
    ...
    snapshot: "<p>This is a paragraph.</p>",
  },
  "renders multiple paragraphs": {
    input: "First paragraph.\n\nSecond paragraph.",
    snapshot: "<p>First paragraph.</p><p>Second paragraph.</p>",
  },
  "renders italic text with asterisks": {
    input: "*italic*",
    snapshot: "<p><em>italic</em></p>",
  },
  ...
  "renders bold text with double asterisks": {
    input: "**bold**",
    snapshot: "<p><strong>bold</strong></p>",
  },
  ...
  "renders emphasis within paragraph": {
    ...
    snapshot: "<p>This is <em>italic</em> and <strong>bold</strong> text.</p>",
  },
  "renders strikethrough text": {
    input: "~~strikethrough~~",
    snapshot: "<p>~~strikethrough~~</p>",
  },
  "renders strikethrough within paragraph": {
    input: "This is ~~deleted~~ text.",
    snapshot: "<p>This is ~~deleted~~ text.</p>",
  },
  "renders bullet list with dashes": {
    input: "- Item 1\n- Item 2\n- Item 3",
    snapshot: "<ul ><li>Item 1</li><li>Item 2</li><li>Item 3</li></ul>",
  },
  ...
  "renders inline code": {
    input: "`code`",
    snapshot:
      '<p><code style="background-color:var(--cm-editor-background, rgba(128, 128, 128, 0.1));padding:2px 4px;border-radius:3px;font-family:monospace">code</code></p>',
  },
  "renders inline code within paragraph": {
    input: "Use `console.log()` to debug.",
    snapshot:
      '<p>Use <code style="background-color:var(--cm-editor-background, rgba(128, 128, 128, 0.1));padding:2px 4px;border-radius:3px;font-family:monospace">console.log()</code> to debug.</p>',
  },
  "renders fenced code block": {
    input: "```\nconst x = 1;\nconsole.log(x);\n```",
    snapshot: "<code>const x = 1;\nconsole.log(x);</code>",
  },
  ...
  "renders indented code block break": {
    input: "    const x = 1;\nconsole.log(x);",
    snapshot: "<code>const x = 1;</code><p>console.log(x);</p>",
  },
  "renders inline link": {
  ...
  "renders image": {
    ...
    snapshot: '<p><img src="image.jpg" alt="Alt text"></p>',
  },
  "renders blockquote": {
    input: "> This is a blockquote.",
    snapshot: "<blockquote><p>This is a blockquote.</p></blockquote>",
  },
  "renders multi-line blockquote": {
    input: "> First line\n> Second line",
    snapshot: "<blockquote><p>First line\nSecond line</p></blockquote>",
  },
  "renders multi-line blockquote with empty line": {
    input: "> First line\n>\n> Second line",
    snapshot: "<blockquote><p>First line</p><p>Second line</p></blockquote>",
  },
  ...
  "handles backslash escapes": {
    input: "\\*not italic\\*",
    snapshot: "<p>*not italic*</p>",
  },
  "handles escaped characters": {
    input: "\\# Not a header",
    snapshot: "<p># Not a header</p>",
  },
  ...
  "renders lists with multiple paragraphs in items": {
    ...
    snapshot:
      "<ol ><li><p>First item with multiple paragraphs.</p><p>This is the second paragraph of the first item.</p></li><li><p>Second item with code:</p><code>console.log('Hello from list');</code></li></ol>",
  },
  ...
  "renders strikethrough with nested emphasis": {
    ...
    snapshot:
      "<p>~~This is deleted with <strong>bold</strong> and <em>italic</em> text~~</p>",
  },
  "renders complex nested emphasis combinations": {
    input: "***This is bold and italic*** with ~~strikethrough **and bold**~~",
    snapshot:
      "<p><em><strong>This is bold and italic</strong></em> with ~~strikethrough <strong>and bold</strong>~~</p>",
  },
  ...
  "renders code within links": {
    ...
    snapshot:
      '<p><a href="https://developer.mozilla.org" target="_blank" rel="noopener noreferrer">Check out <code style="background-color:var(--cm-editor-background, rgba(128, 128, 128, 0.1));padding:2px 4px;border-radius:3px;font-family:monospace">console.log()</code></a></p>',
  },
  "renders inline code with emphasis markers that should not be processed": {
    input: "`const **bold** = 'not bold';`",
    snapshot:
      "<p><code style=\"background-color:var(--cm-editor-background, rgba(128, 128, 128, 0.1));padding:2px 4px;border-radius:3px;font-family:monospace\">const **bold** = 'not bold';</code></p>",
  },
  "renders code blocks in lists": {
    input:
      "1. Install dependencies:\n   ```bash\n   npm install\n   ```\n\n2. Run the application:\n   ```javascript\n   npm start\n   ```",
    snapshot:
      "<ol ><li>Install dependencies:<code>npm install</code></li><li>Run the application:<code>npm start</code></li></ol>",
  },
  "renders code blocks in nested lists": {
    input:
      "1. Install dependencies:\n   ```bash\n   npm install\n   ```\n\n   1. Run the application:\n      ```javascript\n      npm start\n      ```",
    snapshot:
      "<ol ><li><p>Install dependencies:</p><code>npm install</code><ol ><li>Run the application:<code>npm start</code></li></ol></li></ol>",
  },
  "renders code blocks in blockquotes": {
    input:
      '> Here\'s an example:\n> \n> ```javascript\n> function hello() {\n>   return "world";\n> }\n> ```',
    snapshot:
      '<blockquote><p>Here\'s an example:</p><code>function hello() {\n  return "world";\n}</code></blockquote>',
  },
  ...
  "handles proper separated emphasis correctly": {
    input: "**this** is **bold**",
    snapshot: "<p><strong>this</strong> is <strong>bold</strong></p>",
  },
  ...
  "handles images without src": {
    input: "![Alt text]()",
    snapshot: '<p><img src="" alt="Alt text"></p>',
  },
  ...
  "allows custom emphasis renderer": {
    ...
    snapshot: "<p>This is <em>custom italic</em> text</p>",
  },
  ...
  "allows chaining of custom renderers": {
    ...
    snapshot: "<p><strong>Bold</strong> and <em>italic</em> text</p>",
  },
} satisfies Spec;
